...
public class ReservaSpecifications {
    ...
    public static Specification<ReservasDisponiveisEntity> comFiltros(Long idTipoQuadra, LocalDate data, LocalTime hora, StatusReserva status) {
    ...
    public static Specification<HistoricoReservasEntity> comFiltrosHistorico(Long idTipoQuadra, LocalDate data, LocalTime hora, StatusReserva status) {
        return (root, query, cb) -> {
            List<Predicate> predicates = new ArrayList<>();
